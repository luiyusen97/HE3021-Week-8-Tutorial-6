...
A Breusch-Godfrey test was also conducted on the regression of residuals. Using the forecast package, a Ljung-Box test was also conducted directly on the ARIMA model object.
```{r, echo=TRUE}
